...
CHRONOMETER = pygame.image.load(os.path.join(IMG_DIR, 'Other/Chronometer.png'))
CHRONOMETER_TYPE = "chronometer"

HALF_HEART = pygame.image.load(os.path.join(IMG_DIR, 'Other/HalfHeart.png'))
HALF_HEART_TYPE = "half_heart"
